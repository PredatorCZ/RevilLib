...
static const std::map<uint32, pair_type> extensions{
    ...
    {0x056CCDBC, {"tucyl", "rTutorialCylinderData"}},
    ...
    {0x0AB54515, {"bui", "rBui"}},
    {0x0AD816B6, {"pmc", "rPlayerMoveConfigData"}},
    ...
    {0x0B314649, {"swp", "rShopWeaponParam"}},
    ...
    {0x0CF7FB37, {"msf", "rSoundSourceMSF"}},
    ...
    {0x0DF1E4CD, {"gstd", "rGatherSetTableDataNative"}},
    ...
    {0x0F9C5829, {"shp", "rShellParam"}},
    {0x0F9F3E69, {"pmtt", "rPlayerMotionTimeTable"}},
    {0x1001DC34, {"ptc", "rPawnThinkControl"}},
    {0x101B237C, {"idd", "rInstanceDrawDistance"}},
    {0x1041BD9E, {"mod", "rModel"}},
    {0x10A7BB93, {"fpi", "rFieldPartsInfoNative"}},
    {0x10A9B96B, {"cut", "rTalkDemoCut"}},
    ...
    {0x11AFA688, {"sdl.xml", "rSchedulerXml"}},
    ...
    {0x136FAD9F, {"ril", "rRewardItemLottery"}},
    {0x139EE51D, {"lmt", "rMotionList"}},
    {0x13AC3D41, {"dpt", "rDuctPoint"}},
    {0x13BC0ACE, {"mser", "rLptSoundMotionSe"}},
    ...
    {0x14A7B5C9, {"wsi", "rWeatherStageInfo"}},
    ...
    {0x166CDDCF, {"strd", "rStoryRoute"}},
    {0x167DBBFF, {"stq", "rSoundStreamRequest"}},
    {0x1688C822, {"btat", "rBattleAtkNative"}},
    ...
    {0x1D6CAB29, {"scl", "rSequenceCameraList"}},
    {0x1D8CC9B7, {"fol", "rFieldObjectList"}},
    {0x1DA0352D, {"tpi", "rTenkaPlInfo"}},
    ...
    {0x22E107B2, {"wmi", "rWepModelInfo"}},
    {0x231009FD, {"slm", "rShlLimit"}},
    {0x2325C7A0, {"mectd", "rMonsterEnumConversionTable"}},
    {0x232E228C, {"rev_win", "rSoundReverb"}},
    {0x233A2C4D, {"plgmktype", "rPlayerGimmickType"}},
    ...
    {0x25A425FF, {"pssl", "rPawnSpSkillLevelUI"}},
    {0x25A60BC4, {"ssjje", "rSansaijijiExchange"}},
    {0x25B4A6B9, {"bgm", "rSoundBGMControl"}},
    {0x25E98D8C, {"rclp", "rRoomCutListPackage"}},
    ...
    {0x27662FAE, {"fpctl", "rFacialPartsControl"}},
    ...
    {0x2B73DB4A, {"work", "rTalkDemoWorkOriginInfo"}},
    ...
    {0x2D6455B1, {"tde", "rTextureDetailEdit"}},
    ...
    {0x2F94F561, {"acd", "rAtkCollData"}},
    {0x2FC0C6C5, {"tuto", "rTutorialFlowData"}},
    ...
    {0x3366F207, {"fpc", "rFacialPartsComboNative"}},
    ...
    {0x3565348B, {"asd", "rMergeStreamDataNative"}},
    ...
    {0x3A7C0812, {"etp", "rEnemyHMThinkParam"}},
    ...
    {0x40D14033, {"gfc", "rFlashFontConfig"}},
    ...
    {0x445F93C9, {"fpl", "rFieldPartsLayoutNative"}},
    {0x447F4B2C, {"peg", "rEmoteGroup"}},
    {0x44A96149, {"acs", "rAccessorySkill"}},
    {0x44C79ADC, {"fmu", "rFreeMissionUnlock"}},
    ...
    {0x494CE020, {"rew", "rRewardDrop"}},
    {0x494EA0DD, {"cfid", "rChestItemTableDataNative"}},
    {0x496F8F22, {"fup", "rFreeUseParam"}},
    {0x49726B60, {"bjt", "rBakeJoint"}},
    {0x49A855DA, {"jul", "rJumpList"}},
    {0x49B5A885, {"ssc", "rSoundSimpleCurve"}},
    {0x49BDEA0C, {"evm", "rEventManage"}},
    {0x49DA82CA, {"hmeparam", "rHumanEnemyParam"}},
    ...
    {0x4AC5C529, {"bgt", "rBaseGuideMessage"}},
    ...
    {0x4CD902BC, {"vpi", "rVersusPlayerInfo"}},
    {0x4CDF60E9, {"msg", "rMessage"}},
    {0x4CE4AB66, {"sbt", "rShopBargainTable"}},
    {0x4CE8577B, {"vii", "rVersusIntroInfo"}},
    ...
    {0x4FE235C1, {"ecp", "rEcParam"}},
    {0x5001FCC8, {"bstr", "rBattleStageResource"}},
    {0x50475E5B, {"idcol", "rIDColor"}},
    ...
    {0x540D49C1, {"plweplist", "rPlayerWeaponList"}},
    ...
    {0x5554B934, {"ipr", "rInstancePlacement"}},
    ...
    {0x57265000, {"cia", "rCafeItemAdditionParam"}},
    {0x5726B72C, {"ompe", "rOmParamEx"}},
    {0x5727C577, {"at3", "rRewardWeaponRarity"}},
    ...
    {0x5A4D542F, {"rda", "rResultData"}},
    {0x5A525C16, {"pel", "rProofEffectList"}},
    {0x5A61A7C8, {"fed", "rFaceEdit"}},
    {0x5A641E32, {"kzt", "rRewardKoduchiTbl"}},
    ...
    {0x5B9300CB, {"snd", "rTalkDemoSound"}},
    {0x5B99F299, {"tul", "rTenkaUnlock"}},
    {0x5C0B0996, {"csl", "rCutStartList"}},
    {0x5C7FF59D, {"csl", "rCostumeList"}},
    {0x5C82A29C, {"pssc", "rPawnSpSkillCategoryUI"}},
    ...
    {0x5DCEA23F, {"occ2", "rOccluder2Native"}},
    ...
    {0x5F3DFA3C, {"wdl", "rWeaponDataList"}},
    {0x5F6A387F, {"cms", "rCommonScript"}},
    {0x5F84F7C4, {"mem.wmv", "rMovieOnMemory"}},
    ...
    {0x5FF4BE71, {"enem", "rBio_cvENE"}},
    {0x6005E229, {"fcl", "rFontColor"}},
    {0x600688E3, {"rwh", "rRewardWeaponHitOrMiss"}},
    {0x601E64CD, {"szs", "rSoundZoneSwitch"}},
    {0x603E58D5, {"vip", "rVersusItemParam"}},
    {0x60524FBB, {"shw", "rShapeWeight"}},
    ...
    {0x62220853, {"vfp", "rVillageFirstPos"}},
    ...
    {0x62711A14, {"ts", "rTraceSonarNative"}},
    ...
    {0x664DCCA3, {"rlp", "rRewardLayoutPattern"}},
    {0x666F5559, {"fpos", "rFieldPlacementObjectSetNative"}},
    {0x6677C6A3, {"sbd", "rShopBasicData"}},
    {0x66B45610, {"fsm", "rAIFSM"}},
    {0x66BCC342, {"lsl", "rLptMotSequenceList"}},
    ...
    {0x67C828FE, {"abd", "rAcquirement::rAbilityData"}},
    {0x67DE29F7, {"spll", "rSchedulerPreLoadList"}},
    {0x6812D2EC, {"rtd", "rRouteData"}},
    {0x681835FC, {"itmm", "rBio_cvITM"}},
    ...
    {0x69E3A783, {"17d", "rEm017Data"}},
    {0x69F530CE, {"wpp", "rWepParam"}},
    ...
    {0x6AFF2211, {"caip", "rCaughtInfoParam"}},
    {0x6B0369B1, {"atrm", "rBio_cvATR"}},
    {0x6B41A2F9, {"scd", "rStageCameraData"}},
    {0x6B571E45, {"lgtm", "rBio_cvLGT"}},
    ...
    {0x6D32A44B, {"itp", "rInstructorThinkParam"}},
    ...
    {0x6EEAD597, {"bcp", "rBotThinkParam"}},
    {0x6EF2AAD4, {"sol", "rSortList"}},
    ...
    {0x6FCFA2EC, {"dmp", "rDamageTuningParam"}},
    {0x6FE1EA15, {"spl", "rSoundPhysicsList"}},
    {0x6FF78212, {"ari", "rAreaInfo"}},
    {0x70108A0A, {"ecl", "rEffectCallList"}},
    {0x701B8556, {"wpdt", "rWipeData"}},
    {0x7039F76F, {"oxpv", "rOtQuestExpValue"}},
    {0x7050198A, {"pmb", "rBio_cvPMB"}},
    ...
    {0x72486806, {"wul", "rWepUpGradeList"}},
    ...
    {0x72B4E538, {"npm", "rNPCParam"}},
    {0x72CCDE0E, {"apt", "rArmorParamTable"}},
    {0x72D5B36A, {"evp", "rAIEnemyThinkPoint"}},
    ...
    {0x7613E765, {"rut", "rRouletteUseType"}},
    {0x7618CC9A, {"mtnm", "rBio_cvMTN"}},
    {0x763119DC, {"pos", "rTalkDemoObjInitPos"}},
    {0x763B5C41, {"kcp", "rKeyCustomParam"}},
    {0x7646EAE3, {"evsi", "rEventViewerSetInfo"}},
    {0x764BD096, {"rwm", "rRewardWeaponMeiLottery"}},
    ...
    {0x77293528, {"spl", "rSndPitchLimit"}},
    {0x7766ACE5, {"ckc", "rCraftSkillCost"}},
    {0x77892F95, {"hlt", "rHumanLevelTable"}},
    {0x77967F14, {"vsm", "rVsMissileParam"}},
    ...
    {0x78E0DEE6, {"ebp", "rEnemyHMBasicParam"}},
    {0x790203B0, {"angryprm", "rAngryParam"}},
    {0x790F56DE, {"fco", "rFieldCamOption"}},
    {0x791DA5C9, {"tbl", "rTable"}},
    {0x7963691C, {"npt", "rNPCPath"}},
    ...
    {0x7AEFA722, {"fcp", "rFSMCameraParam"}},
    {0x7AF36DC1, {"nstmsg", "rNestMessage"}},
    {0x7B54B600, {"atd", "rActivityData"}},
    {0x7B572569, {"olsk", "rOtLotOwnSkill"}},
    {0x7B69C8BF, {"bbp", "rBossBasicParam"}},
    {0x7B7469E5, {"cls", "rCharacterList"}},
    ...
    {0x7CFF2106, {"swr", "rShopWeaponRankTable"}},
    ...
    {0x7EC37134, {"bql", "rBaseQuestItemList"}},
    ...
    {0x7F68C6AF, {"mpac", "rBio_cvMPAC"}},
    {0x7F92D75B, {"ach", "rAchievementHeader"}},
    {0x7F99F211, {"motparam", "rMotionParam"}},
    {0x7F9FE4E7, {"osp", "rOcdStatusParamRes"}},
    {0x7FFD90D7, {"h29", "rHm29Param"}},
};

static decltype(extensions) extensionsPS3{
    {0x232E228C, {"rev_ps3", "rSoundReverb"}},
    {0x3821B94D, {"at3", "rSoundSourceMusic"}},
    {0x4857FD94, {"rev_ps3", "rPlanetReverb"}},
...
static decltype(extensions) extensionsN3DS{
    {0x059BC928, {"arg", "rArrange"}},
    {0x15302EF4, {"lyt", "rLayout"}},
    {0x232E228C, {"revr_ctr", "rSoundReverb"}},
    {0x2B40AE8F, {"equr", "rSoundEQ"}},
    {0x3FB52996, {"mix", "rItemMix"}},
    {0x6E45FABB, {"atp", "rAttackParam"}},
};

static decltype(extensions) extensionsNSW{
    {0x167DBBFF, {"stqr", "rSoundStreamRequest"}},
    {0x1BCC4966, {"srqr", "rSoundRequest"}},
    {0x232E228C, {"revr", "rSoundReverb"}},
    {0x79C47B59, {"adpcm", "rSoundSourceADPCM"}},
};
